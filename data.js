...
let p1 = new makeupproduct("https://3.imimg.com/data3/BX/CS/MY-3792183/foundation-500x500.jpg", "Foundation")
...
// document.getElementById("eyedata").addEventListener("click", function () {
...
// document.getElementById("lipcaredata").addEventListener("click", function () {
...
import {product_homeservicecontactabout ,lastfootersectionjs } from "./component/allscript.js";
